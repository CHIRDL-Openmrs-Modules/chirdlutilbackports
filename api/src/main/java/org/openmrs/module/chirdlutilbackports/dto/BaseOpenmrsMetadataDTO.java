...
/**
 * DTO class for the BaseOpenmrslMetadata class
 * 
 * @author Steve McKee
 */
public abstract class BaseOpenmrsMetadataDTO extends BaseOpenmrsObjectDTO {
	...
	/**
	 * Populates the BaseOpenmrsMetadataDTO from the BaseOpenmrsMetadata.
	 * 
	 * @param source The BaseOpenmrsMetadata object
	 * @param destination The BaseOpenmrsMetadataDTO object
	 */
	public static void convertFrom(BaseOpenmrsMetadata source, BaseOpenmrsMetadataDTO destination) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BaseOpenmrsMetadataDTO other = (BaseOpenmrsMetadataDTO) obj;
		if (changedBy == null) {
	...
	public String toString() {
		return "BaseOpenmrsMetadataDTO [name=" + name + ", description=" + description + ", creator=" + creator
		        + ", dateCreated=" + dateCreated + ", changedBy=" + changedBy + ", dateChanged=" + dateChanged + ", retired="
		        + retired + ", dateRetired=" + dateRetired + ", retiredBy=" + retiredBy + ", retireReason=" + retireReason
		        + "]";
	}
}
